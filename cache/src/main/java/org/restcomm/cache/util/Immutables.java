...
public class Immutables {
    ...
    public static boolean isImmutable(Object o) {
        return o instanceof org.restcomm.cache.util.Immutables.Immutable;
    }
    ...
    public static TypedProperties immutableTypedProperties(TypedProperties properties) {
        ...
        return new Immutables.ImmutableTypedProperties(properties);
    }
    ...
    public static <T> Set<T> immutableSetWrap(Set<? extends T> set) {
        return new Immutables.ImmutableSetWrapper<T>(set);
    }
    ...
    public static <T> Set<T> immutableSetCopy(Set<T> set) {
        ...
        return new Immutables.ImmutableSetWrapper<T>(copy);
    }
    ...
    public static <K, V> Map<K, V> immutableMapWrap(Map<? extends K, ? extends V> map) {
        return new Immutables.ImmutableMapWrapper<K, V>(map);
    }
    ...
    public static <K, V> Map<K, V> immutableMapCopy(Map<K, V> map) {
        ...
        return new Immutables.ImmutableMapWrapper<K, V>(copy);
    }
    ...
    public static <T> Collection<T> immutableCollectionCopy(Collection<T> collection) {
        ...
        return new Immutables.ImmutableCollectionWrapper<T>(copy);
    }
    ...
    public static <T> Collection<T> immutableCollectionWrap(Collection<? extends T> collection) {
        return new Immutables.ImmutableCollectionWrapper<T>(collection);
    }
    ...
    public static <K, V> Map.Entry<K, V> immutableEntry(Map.Entry<K, V> entry) {
        return new Immutables.ImmutableEntry<K, V>(entry);
    }
    ...
    public static InternalCacheEntry immutableInternalCacheEntry(InternalCacheEntry entry) {
        return new Immutables.ImmutableInternalCacheEntry(entry);
    }
    ...
    */
    ...
    private static class ImmutableCollectionWrapper<E> implements Collection<E>, Serializable, org.restcomm.cache.util.Immutables.Immutable {
        ...
        public Iterator<E> iterator() {
            return new Immutables.ImmutableIteratorWrapper<E>(collection.iterator());
        }
    ...
    private static class ImmutableSetWrapper<E> extends Immutables.ImmutableCollectionWrapper<E> implements Set<E>, Serializable, org.restcomm.cache.util.Immutables.Immutable {
     ...
     */
    private static class ImmutableEntry<K, V> implements Entry<K, V>, org.restcomm.cache.util.Immutables.Immutable {
        private K key;
        private V value;
        private int hash;
     ...
     */
    private static class ImmutableInternalCacheEntry implements InternalCacheEntry, org.restcomm.cache.util.Immutables.Immutable {
        ...
        public InternalCacheValue toInternalCacheValue() {
            return new Immutables.ImmutableInternalCacheValue(this);
        }
        ...
        public InternalCacheEntry clone() {
            return new Immutables.ImmutableInternalCacheEntry(entry.clone());
        }
    }

    private static class ImmutableInternalCacheValue implements InternalCacheValue, org.restcomm.cache.util.Immutables.Immutable {
        private final Immutables.ImmutableInternalCacheEntry entry;

        ImmutableInternalCacheValue(Immutables.ImmutableInternalCacheEntry entry) {
            this.entry = entry;
        }
    ...
    private static class ImmutableEntrySetWrapper<K, V> extends Immutables.ImmutableSetWrapper<Entry<K, V>> {
        ...
        public Iterator<Entry<K, V>> iterator() {
            return new Immutables.ImmutableIteratorWrapper<Entry<K, V>>(collection.iterator()) {
                @Override
                public Entry<K, V> next() {
                    return new Immutables.ImmutableEntry<K, V>(super.next());
                }
            };
        }
    }

    private static class ImmutableMapWrapper<K, V> implements Map<K, V>, Serializable, org.restcomm.cache.util.Immutables.Immutable {
        ...
        public Set<Entry<K, V>> entrySet() {
            return new Immutables.ImmutableEntrySetWrapper<K, V>(map.entrySet());
        }
        ...
        @Override
        public Set<K> keySet() {
            return new Immutables.ImmutableSetWrapper<K>(map.keySet());
        }
        ...
        public Collection<V> values() {
            return new Immutables.ImmutableCollectionWrapper<V>(map.values());
        }
    ...
    public static class ImmutableMapWrapperExternalizer extends AbstractExternalizer<Map> {
        ...
        public Map readObject(ObjectInput input) throws IOException, ClassNotFoundException {
            ...
            return org.restcomm.cache.util.Immutables.immutableMapWrap(map);
        }
        ...
        public Set<Class<? extends Map>> getTypeClasses() {
            return Util.<Class<? extends Map>>asSet(Immutables.ImmutableMapWrapper.class);
        }
    }
    ...
    private static class ImmutableTypedProperties extends TypedProperties {
        ...
        public Set<java.util.Map.Entry<Object, Object>> entrySet() {
            return new Immutables.ImmutableEntrySetWrapper<Object, Object>(super.entrySet());
        }

        @Override
        public Set<Object> keySet() {
            return new Immutables.ImmutableSetWrapper<Object>(super.keySet());
        }
        ...
        public Set<String> stringPropertyNames() {
            return new Immutables.ImmutableSetWrapper<String>(super.stringPropertyNames());
        }

        @Override
        public Collection<Object> values() {
            return new Immutables.ImmutableCollectionWrapper<Object>(super.values());
        }
